...
public class StockPriceClient {
    ...
    public static void main(String[] args) throws Exception {
    	// 1a. Create a socket that connect to localhost at port 59898
        ...
        // 1b. use PrintWriter to handle socket output stream and BufferedReader
        ...
        try (Socket socket = new Socket(host, 59898)) {
            ...
            String readline = "";
            String response = "";
            // 1c. allow user to send stock code to the server and receive response
            // 1d. implement logic to terminate the connection. (eg. when receiving 'exit' msg)
            while(true) {
            	try {
